...
import useVehicles from '@/features/vehicles/hooks/useVehicles'; // make sure this path is correct
...
export default function VehicleListPage() {
  ...
  // Fetch vehicles using your custom hook
        ...
        <div className="w-full mt-4 space-y-4">
          ...
          {!loading && !error && data?.length > 0 ? (
            data
              ...
              .map((v) => (
                <VehicleCard key={v.vehicle_id || v.id} vehicle={v} />
              ))
          ) : (
